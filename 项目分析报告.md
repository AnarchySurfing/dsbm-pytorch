...
- **算法对比**：
  ...
  # DSBM-IPF方法
  python DSBM-Gaussian.py dim=5,20,50 model_name=dsbm seed=1,2,3,4,5
  
  # DSBM-IMF创新方法
  python DSBM-Gaussian.py dim=5,20,50 model_name=dsbm first_coupling=ind seed=1,2,3,4,5
  ```
